...
Agent::Agent() :
    ...
    intf_table_(NULL), health_check_table_(), metadata_ip_allocator_(),
    metadata_ip6_allocator_(nullptr), nh_table_(NULL), uc_rt_table_(NULL), mc_rt_table_(NULL),
    ...
    local_peer_(), local_vm_peer_(), linklocal_peer_(),
    ecmp_peer_(), vgw_peer_(), evpn_routing_peer_(),
    vxlan_bgp_peer_(), evpn_peer_(), multicast_peer_(),
    multicast_tor_peer_(), multicast_tree_builder_peer_(),mac_vm_binding_peer_(),
    inet_evpn_peer_(), mac_learning_peer_(), fabric_rt_export_peer_(),
    local_vm_export_peer_(), agent_signal_(), ifmap_parser_(NULL),
