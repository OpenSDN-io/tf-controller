...
TestFlowXmlAgentInit::TestFlowXmlAgentInit() : TestAgentInit() {
}

TestFlowXmlAgentInit::~TestFlowXmlAgentInit() {
}
...
// by init module
void TestFlowXmlAgentInit::CreateModules() {
    TestAgentInit::CreateModules();
}

void TestFlowXmlAgentInit::CreateDBTables() {
    TestAgentInit::CreateDBTables();
}

void TestFlowXmlAgentInit::RegisterDBClients() {
...
TestClient *XmlPktParseTestInit(const char *init_file, bool ksync_init) {
    ...
    TestClient *client = new TestClient(new TestFlowXmlAgentInit());
    TestFlowXmlAgentInit *init =
        static_cast<TestFlowXmlAgentInit *>(client->agent_init());
